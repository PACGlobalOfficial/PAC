...
const char * const BITCOIN_PID_FILENAME = "pacglobald.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PACGlobal
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PACGlobal
    // Mac: ~/Library/Application Support/PACGlobal
    // Unix: ~/.PACGlobal
#ifdef WIN32
    // Windows
